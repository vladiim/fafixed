"""
Django settings for veridy project.
...
SECRET_KEY = 'django-insecure-u-453c8u4!*r0++620plvz66*8d2uh5kj5%^$++s$tmc=x8uvk'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.current_user_and_account',
            ],
        },
    },
]

WSGI_APPLICATION = 'veridy.wsgi.application'
ASGI_APPLICATION = 'veridy.asgi.application'
...
FIELD_ENCRYPTION_KEY = os.getenv('INTEGRATION_ENCRYPTION_KEY')
